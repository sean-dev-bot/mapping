...
|------------|------|--------|----------|
| PKglBalLosGlPropAcctKey | CLUSTERED | ✓ | BalKeyTID |
| XAKglBalLosGlPropAcctKey | NONCLUSTERED |  | CorpHID, PropHID, RptClass, RptDetail, RptItem, BalDefSrce |
| XIP1glBalLosGlPropAcctKey | NONCLUSTERED | ✓ | CorpHID, BalKeyTID |
| XIP2glBalLosGlPropAcctKey | NONCLUSTERED | ✓ | PropHID, BalKeyTID |
