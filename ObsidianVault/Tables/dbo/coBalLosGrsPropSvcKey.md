...
|------------|------|--------|----------|
| PKcoBalLosGrsPropSvcKey | CLUSTERED | ✓ | BalKeyTID |
| XAKcoBalLosGrsPropSvcKey | NONCLUSTERED |  | CorpHID, PropHID, RptClass, RptDetail, RptItem, BalDefSrce |
| XIP1coBalLosGrsPropSvcKey | NONCLUSTERED | ✓ | CorpHID, BalKeyTID |
| XIP2coBalLosGrsPropSvcKey | NONCLUSTERED | ✓ | PropHID, BalKeyTID |
