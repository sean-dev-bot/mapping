...
|------------|------|--------|----------|
| PKcoBalMIGrsPropAcctKey | CLUSTERED | ✓ | BalKeyTID |
| XAKcoBalMIGrsPropAcctKey | NONCLUSTERED |  | CorpHID, PropHID, InqSection, InqClass, InqDetail, InqItem, BalDefSrce |
| XIP1coBalMIGrsPropAcctKey | NONCLUSTERED | ✓ | CorpHID, BalKeyTID |
| XIP2coBalMIGrsPropAcctKey | NONCLUSTERED | ✓ | PropHID, BalKeyTID |
