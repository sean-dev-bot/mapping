...
|------------|------|--------|----------|
| PKglBalMIGLPropAcctKey | CLUSTERED | ✓ | BalKeyTID |
| XAKglBalMIGLPropAcctKey | NONCLUSTERED |  | CorpHID, PropHID, InqSection, InqClass, InqDetail, InqItem, BalDefSrce |
| XIP1glBalMIGLPropAcctKey | NONCLUSTERED | ✓ | CorpHID, BalKeyTID |
| XIP2glBalMIGLPropAcctKey | NONCLUSTERED | ✓ | PropHID, BalKeyTID |
