...
|------------|------|--------|----------|
| PKcoBalMINetPropSvcKey | CLUSTERED | ✓ | BalKeyTID |
| XAKcoBalMINetPropSvcKey | NONCLUSTERED |  | CorpHID, OwnerHID, PropHID, InqSection, InqClass, InqDetail, InqItem, SysIntCode, BalDefSrce |
| XIP1coBalMINetPropSvcKey | NONCLUSTERED | ✓ | CorpHID, BalKeyTID |
| XIP2coBalMINetPropSvcKey | NONCLUSTERED | ✓ | OwnerHID, BalKeyTID |
| XIP3coBalMINetPropSvcKey | NONCLUSTERED | ✓ | PropHID, BalKeyTID |
