...
|------------|------|--------|----------|
| PKglBalLosGLPropSvcKey | CLUSTERED | ✓ | BalKeyTID |
| XAKglBalLosGLPropSvcKey | NONCLUSTERED |  | CorpHID, PropHID, RptClass, RptDetail, RptItem, BalDefSrce |
| XIP1glBalLosGLPropSvcKey | NONCLUSTERED | ✓ | CorpHID, BalKeyTID |
| XIP2glBalLosGLPropSvcKey | NONCLUSTERED | ✓ | PropHID, BalKeyTID |
